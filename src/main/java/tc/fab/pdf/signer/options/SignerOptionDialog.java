...
/*
 * SignerOptionDialog.java
 *
 * Created on 20/04/2009, 16:55:58
 */
...
public class SignerOptionDialog extends javax.swing.JDialog {
	...
	/** Creates new form SignerOptionDialog */
	public SignerOptionDialog(java.awt.Frame parent, boolean modal) {
		...
		resourceMap = org.jdesktop.application.Application.getInstance()
				.getContext().getResourceMap(SignerOptionDialog.class);

		actionMap = org.jdesktop.application.Application.getInstance()
				.getContext().getActionMap(SignerOptionDialog.class, this);
		...
		panelPosition.setBorder(javax.swing.BorderFactory.createTitledBorder(
				null, resourceMap.getString("panelPosition.border.title"),
		...
		spinnerMarginBottom.setModel(new javax.swing.SpinnerNumberModel(Float
		...
		toggleLeft.setActionCommand(resourceMap
				.getString("toggleLeft.actionCommand")); // NOI18N
		...
		toggleCenter.setActionCommand(resourceMap
				.getString("toggleCenter.actionCommand")); // NOI18N
		...
		toggleRight.setActionCommand(resourceMap
				.getString("toggleRight.actionCommand")); // NOI18N
		...
		javax.swing.GroupLayout gl_panelAlign = new javax.swing.GroupLayout(
				panelAlign);
		panelAlign.setLayout(gl_panelAlign);
		gl_panelAlign
				.setHorizontalGroup(gl_panelAlign
						.createParallelGroup(
						...
						.addGroup(
								gl_panelAlign
										...
										.addComponent(
												...
												24,
												javax.swing.GroupLayout.PREFERRED_SIZE)));
		gl_panelAlign.setVerticalGroup(gl_panelAlign
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addComponent(toggleCenter,
						javax.swing.GroupLayout.PREFERRED_SIZE, 24,
						Short.MAX_VALUE)
				.addComponent(toggleRight,
						javax.swing.GroupLayout.PREFERRED_SIZE, 24,
						Short.MAX_VALUE)
				.addComponent(toggleLeft, 0, 0, Short.MAX_VALUE));
		...
		labelFooterDistance.setText(resourceMap
				.getString("labelFooterDistance.text")); // NOI18N
		labelFooterDistance.setName("labelFooterDistance"); // NOI18N
		labelFooterDistance.setPreferredSize(null);

		labelLastLineDistance.setText(resourceMap
				.getString("labelLastLineDistance.text")); // NOI18N
		labelLastLineDistance.setName("labelLastLineDistance"); // NOI18N
		labelLastLineDistance.setPreferredSize(null);

		spinnerFooterDistance.setModel(new javax.swing.SpinnerNumberModel(Float
				.valueOf(0.0f), null, null, Float.valueOf(0.2f)));
		spinnerFooterDistance.setName("spinnerFooterDistance"); // NOI18N
		spinnerFooterDistance.setPreferredSize(null);

		spinnerLastLineDistance.setModel(new javax.swing.SpinnerNumberModel(
				Float.valueOf(0.0f), null, null, Float.valueOf(0.2f)));
		...
		javax.swing.GroupLayout gl_panelTipo = new javax.swing.GroupLayout(
				panelTipo);
		...
		javax.swing.GroupLayout gl_panelPosition = new javax.swing.GroupLayout(
				panelPosition);
		panelPosition.setLayout(gl_panelPosition);
		gl_panelPosition
				.setHorizontalGroup(gl_panelPosition
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								gl_panelPosition
										...
										.addContainerGap()));
		gl_panelPosition
				.setVerticalGroup(gl_panelPosition
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								gl_panelPosition
		...
		checkAutomaticSize.setText(resourceMap
				.getString("checkAutomaticSize.text")); // NOI18N
		checkAutomaticSize.setName("checkAutomaticSize"); // NOI18N

		javax.swing.GroupLayout gl_panelSize = new javax.swing.GroupLayout(
				panelSize);
		gl_panelSize.setHorizontalGroup(gl_panelSize.createParallelGroup(
				...
				gl_panelSize
						...
						.addComponent(textWidth, GroupLayout.PREFERRED_SIZE,
		...
		panelImage.setToolTipText(resourceMap
				.getString("panelImage.toolTipText")); // NOI18N
		...
		buttonSelectImageFile.setIcon(resourceMap
				.getIcon("buttonSelectImageFile.icon")); // NOI18N
		buttonSelectImageFile.setText(resourceMap
				.getString("buttonSelectImageFile.text")); // NOI18N
		buttonSelectImageFile.setName("buttonSelectImageFile"); // NOI18N

		textFilenameImage.setEditable(false);
		textFilenameImage.setText(resourceMap
				.getString("textFilenameImage.text")); // NOI18N
		...
		gl_jPanel6.setVerticalGroup(gl_jPanel6.createParallelGroup(
				...
				gl_jPanel6
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.BASELINE)
						.addComponent(textCustom,
								javax.swing.GroupLayout.PREFERRED_SIZE, 24,
								javax.swing.GroupLayout.PREFERRED_SIZE)
						.addComponent(spinnerFont,
								javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE,
								javax.swing.GroupLayout.PREFERRED_SIZE)
		...
		javax.swing.GroupLayout gl_panelImage = new javax.swing.GroupLayout(
				panelImage);
		panelImage.setLayout(gl_panelImage);
		gl_panelImage
				.setHorizontalGroup(gl_panelImage
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								gl_panelImage
										...
										.addContainerGap()));
		gl_panelImage
				.setVerticalGroup(gl_panelImage
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								gl_panelImage
		...
		checkLocalization.setText(resourceMap
				.getString("checkLocalization.text")); // NOI18N
		...
		textLocalization
				.setText(resourceMap.getString("textLocalization.text")); // NOI18N
		...
		javax.swing.GroupLayout gl_panelText = new javax.swing.GroupLayout(
				panelText);
		panelText.setLayout(gl_panelText);
		gl_panelText
				.setHorizontalGroup(gl_panelText
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								gl_panelText
		...
		panelOutput.setBorder(javax.swing.BorderFactory.createTitledBorder(
				null, resourceMap.getString("panelOutput.border.title"),
				javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
				javax.swing.border.TitledBorder.DEFAULT_POSITION,
		...
		javax.swing.GroupLayout gl_panelOutput = new javax.swing.GroupLayout(
				panelOutput);
		panelOutput.setLayout(gl_panelOutput);
		gl_panelOutput
				.setHorizontalGroup(gl_panelOutput
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								gl_panelOutput
										...
										.addContainerGap()));
		gl_panelOutput
				.setVerticalGroup(gl_panelOutput
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								gl_panelOutput
		...
		gl_panelAppearance
				.setHorizontalGroup(gl_panelAppearance
						.createParallelGroup(Alignment.LEADING)
						.addGroup(
								gl_panelAppearance
										.createSequentialGroup()
										...
										.addGroup(
												gl_panelAppearance
														...
														.addComponent(
																...
																GroupLayout.PREFERRED_SIZE))
										.addContainerGap()));
		gl_panelAppearance.setVerticalGroup(gl_panelAppearance
				.createParallelGroup(Alignment.LEADING).addGroup(
						gl_panelAppearance
								.createSequentialGroup()
								.addContainerGap()
								.addComponent(panelPosition,
										GroupLayout.PREFERRED_SIZE,
										GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(ComponentPlacement.RELATED)
	...
	private void initBindings() {
		...
		binding = Bindings.createAutoBinding(
				AutoBinding.UpdateStrategy.READ_WRITE, radioImport,
		...
		binding = Bindings.createAutoBinding(
				AutoBinding.UpdateStrategy.READ_WRITE, radioImport,
				ELProperty.create("${selected}"), textFilenameImage,
				BeanProperty.create("enabled"));
		bindingGroup.addBinding(binding);
		...
		binding = Bindings.createAutoBinding(
				AutoBinding.UpdateStrategy.READ_WRITE, radioImport,
				ELProperty.create("${selected}"), labelScale,
				BeanProperty.create("enabled"));
		bindingGroup.addBinding(binding);

		binding = Bindings.createAutoBinding(
				AutoBinding.UpdateStrategy.READ_WRITE, radioImport,
				ELProperty.create("${selected}"), spinnerScale,
				BeanProperty.create("enabled"));
		bindingGroup.addBinding(binding);
		...
		binding = Bindings.createAutoBinding(
				AutoBinding.UpdateStrategy.READ_WRITE, radioCustom,
				ELProperty.create("${selected}"), textCustom,
				BeanProperty.create("enabled"));
		bindingGroup.addBinding(binding);
		//
		binding = Bindings.createAutoBinding(
				AutoBinding.UpdateStrategy.READ_WRITE, checkLocalization,
				ELProperty.create("${selected}"), textLocalization,
				BeanProperty.create("enabled"));
		bindingGroup.addBinding(binding);
		//
		binding = Bindings.createAutoBinding(
				AutoBinding.UpdateStrategy.READ_WRITE, checkReason,
				ELProperty.create("${selected}"), textReason,
				BeanProperty.create("enabled"));
		bindingGroup.addBinding(binding);
		//
		binding = Bindings.createAutoBinding(
				AutoBinding.UpdateStrategy.READ_WRITE, checkOverwrite,
				ELProperty.create("${!selected}"), textPreffix,
				BeanProperty.create("enabled"));
		bindingGroup.addBinding(binding);
		//
		binding = Bindings.createAutoBinding(
				AutoBinding.UpdateStrategy.READ_WRITE, checkOverwrite,
				ELProperty.create("${!selected}"), textSuffix,
				BeanProperty.create("enabled"));
		bindingGroup.addBinding(binding);
		//

		binding = Bindings.createAutoBinding(
				AutoBinding.UpdateStrategy.READ_WRITE, radioAbsolute,
				ELProperty.create("${selected}"), spinnerFooterDistance,
				BeanProperty.create("enabled"));
		bindingGroup.addBinding(binding);
		//
		binding = Bindings.createAutoBinding(
				AutoBinding.UpdateStrategy.READ_WRITE, radioRelative,
				ELProperty.create("${selected}"), spinnerLastLineDistance,
				BeanProperty.create("enabled"));
		bindingGroup.addBinding(binding);
		//

		binding = Bindings.createAutoBinding(AutoBinding.UpdateStrategy.READ,
				radioNameImage, ELProperty.create("${selected}"), spinnerFont,
				BeanProperty.create("enabled"));

		bindingGroup.addBinding(binding);

		binding = Bindings.createAutoBinding(AutoBinding.UpdateStrategy.READ,
				radioCustom, ELProperty.create("${selected}"), spinnerFont,
				BeanProperty.create("enabled"));
		bindingGroup.addBinding(binding);

		binding = Bindings.createAutoBinding(AutoBinding.UpdateStrategy.READ,
				radioNameImage, ELProperty.create("${selected}"), labelFont,
				BeanProperty.create("enabled"));
		bindingGroup.addBinding(binding);

		binding = Bindings.createAutoBinding(AutoBinding.UpdateStrategy.READ,
				radioCustom, ELProperty.create("${selected}"), labelFont,
				BeanProperty.create("enabled"));
		bindingGroup.addBinding(binding);

		binding = Bindings.createAutoBinding(AutoBinding.UpdateStrategy.READ,
				radioRelative, ELProperty.create("${selected}"), checkLastLine,
				BeanProperty.create("enabled"));
		bindingGroup.addBinding(binding);

		binding = Bindings.createAutoBinding(AutoBinding.UpdateStrategy.READ,
				checkLastLine, ELProperty.create("${!selected}"),
				textReference, BeanProperty.create("enabled"));
		bindingGroup.addBinding(binding);

		binding = Bindings.createAutoBinding(AutoBinding.UpdateStrategy.READ,
				radioRelative, ELProperty.create("${selected}"), textReference,
				BeanProperty.create("enabled"));
		bindingGroup.addBinding(binding);
		//

		binding = Bindings.createAutoBinding(
				AutoBinding.UpdateStrategy.READ_WRITE, checkAutomaticSize,
				ELProperty.create("${!selected}"), textWidth,
				BeanProperty.create("enabled"));
		bindingGroup.addBinding(binding);
		//
		binding = Bindings.createAutoBinding(
				AutoBinding.UpdateStrategy.READ_WRITE, checkAutomaticSize,
				ELProperty.create("${!selected}"), textHeight,
				BeanProperty.create("enabled"));
		bindingGroup.addBinding(binding);

		//
		binding = Bindings.createAutoBinding(AutoBinding.UpdateStrategy.READ,
				checkRegex, ELProperty.create("${selected}"), textRegex,
				BeanProperty.create("enabled"));
		bindingGroup.addBinding(binding);
	...
	public void loadOptions(SignerOptions options) {
		...
		if (getOptions().getSignaturePosition().equals(
				SignerOptions.POSITION_ABSOLUTE)) {
		...
		if (options.isSignatureAutomaticSize()) {
			getCheckAutomaticSize().setSelected(
					options.isSignatureAutomaticSize());
		} else {
		...
		if (options.getImage() != null) {
			getTextFilenameImage()
					.setText(options.getImage().getAbsolutePath());
		}
	...
	public SignerOptions saveOptions() throws IOException, URISyntaxException {
		...
		options.setLastLineDistance((Float) getSpinnerLastLineDistance()
				.getValue());
		...
		if (!getTextHeight().getText().isEmpty()) {
			options.setSignatureHeight(Float.parseFloat(getTextHeight()
					.getText()));
		}
		if (!getTextWidth().getText().isEmpty()) {
			options.setSignatureWidth(Float
					.parseFloat(getTextWidth().getText()));
		}
	...
	/**
	 * @return the spinnerFooterDistance
	 */
