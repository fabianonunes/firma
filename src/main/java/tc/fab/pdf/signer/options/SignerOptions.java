...
public class SignerOptions {
	...
	public static SignerOptions newInstance() throws IOException {
		...
		SignerOptions opts;
		LocalStorage lst = PDFSignerApp.getInstance().getContext().getLocalStorage();
	...
	public void addPropertyChangeListener(String eventName, PropertyChangeListener evt) {
		getPcs().addPropertyChangeListener(eventName, evt);
	}

	public void addSelection(IFileSelection selection) throws FileNotFoundException {
	...
	public RenderMode getRenderMode() {
		...
		if (getImageImport() && getImage().exists()) {
			...
			if (getTextDate() || getTextLocal() || getTextName() || getTextReason()) {
