...
public class PDFSignerView extends FrameView {
    ...
    private void initComponents() {
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance().getContext().getActionMap(PDFSignerView.class, this);
        jButton2.setAction(actionMap.get("signSelection")); // NOI18N
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance().getContext().getResourceMap(PDFSignerView.class);
