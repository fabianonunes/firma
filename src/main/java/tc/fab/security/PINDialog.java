...
public class PINDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(tc.fab.pdf.signer.application.PDFSignerApp.class).getContext().getResourceMap(PINDialog.class);
	...
	public void doClose(Boolean action){
		setStatus(action);
		setVisible(false);
		dispose();
	}
